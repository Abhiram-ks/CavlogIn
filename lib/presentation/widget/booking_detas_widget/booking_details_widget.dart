...
import 'package:admin/presentation/widget/booking_detas_widget/booking_clipchip_maker.dart';
import 'package:admin/presentation/widget/booking_detas_widget/booking_custom_details_widget.dart';
          ...
          children: [
            ...
            paymentSummaryTextWidget(
              ...
              prefixTextStyle: GoogleFonts.plusJakartaSans(
                  ...
                  color: () {
                    ...
                    if (status == 'pending') return AppPalette.mainClr;
                  }()),
            ...
            Column(
              children: [
                ...
                paymentSummaryTextWidget(
                  context: context,
                  prefixText: 'Total Service fee',
                  prefixTextStyle: GoogleFonts.plusJakartaSans(
                      fontWeight: FontWeight.w500, color: AppPalette.blackClr),
                  suffixText: '₹ ${model.amountPaid - platformFee}',
                  suffixTextStyle: GoogleFonts.plusJakartaSans(
                      fontWeight: FontWeight.w500, color: AppPalette.redClr),
                ),
                paymentSummaryTextWidget(
                  context: context,
